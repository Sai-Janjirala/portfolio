    ...
    return (
        ...
        >
            ...
            >
                ...
                <div className="h-48 overflow-hidden relative">
                    ...
                    <div className="absolute inset-0 z-20 flex items-center justify-center gap-4 opacity-0 group-hover:opacity-100 transition-all duration-300">
                        <button
                            ...
                            className="p-3 bg-background/80 backdrop-blur-sm text-primary rounded-full hover:bg-primary hover:text-background transition-all shadow-lg border border-border/50 outline-none hover:scale-110"
                        >
                            <Github size={18} />
                        </button>
                        {project.link && (
                ...
                <div className="p-6 relative">
                    ...
                    <div className="flex flex-wrap gap-2 pt-4 border-t border-border/30">
                        {project.tech.map((tech) => (
                            <span key={tech} className="text-xs px-2.5 py-1 rounded-full bg-surface-light/80 text-text-muted border border-border/30 flex items-center gap-1 group-hover:border-primary/20 transition-colors">
                ...
                {/* Number badge */}
                <div className="absolute top-4 right-4 z-30 w-8 h-8 rounded-full bg-background/60 backdrop-blur-sm border border-border/50 flex items-center justify-center">
...
const Projects = () => {
    return (
        <section id="projects" className="py-24 md:py-32 relative overflow-hidden">
            <div className="absolute bottom-0 right-0 w-[500px] h-[500px] bg-primary/5 rounded-full blur-[150px] translate-y-1/2 pointer-events-none" />
            ...
            <div className="container mx-auto px-6 md:px-12 lg:px-20 xl:px-28 relative z-10">
                ...
                >
                    <p className="text-primary text-sm tracking-[0.3em] uppercase font-heading mb-3">My Work</p>
